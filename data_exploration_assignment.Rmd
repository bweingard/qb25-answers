...
```{r}
liver_new <- dt %>% mutate(is_mitochondrial = str_starts(Description, 'MT-'))
...
#Mitochondrial genes are expressed much higher in the liver than nuclear genes, but the median is very low. This suggests that most of the mitochondrial genes are expressed at lower levels, but there are some genes with expression levels so high that they are skewing the mean. The average expression of the nuclear genes are very low, with a median expression level of zero. This means most nuclear genes are not being expressed at all in the liver, but there are some being expressed since the mean is above 0. 
